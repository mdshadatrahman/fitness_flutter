...
class _macro_calculatorState extends State<macro_calculator> {
  ...
  Widget build(BuildContext context) {
    ...
    List select_array = [];
    List Acticity = [
      {"select:": 1, 'title': 'Sedentary'},
      {"select:": 0, 'title': 'Light Activity'},
      {"select:": 0, 'title': 'Moderate'},
    ];
    List primary = [
      {"select:": 1, 'title': 'Loose Weight by 10 %'},
      {"select:": 0, 'title': 'Maintain Weight'},
    ];
    List meals = [
      {
        "select:": 1,
                      ...
                      child: Column(
                        ...
                        children: [
                          const Padding(
                            padding: EdgeInsets.all(8.0),
                            child: Text(
                              "based on your needs and goal, you should eat this many calories per day",
